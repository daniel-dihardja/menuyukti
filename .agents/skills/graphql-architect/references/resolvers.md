...
const resolvers = {
  Query: {
    user: async (parent, args: { id: string }, context: Context): Promise<User | null> => {
...
export function createLoaders(dataSources: DataSources): Loaders {
  return {
    ...
    postsByAuthorLoader: new DataLoader<string, Post[]>(async (authorIds: readonly string[]) => {
...
const resolvers = {
  Post: {
    author: async (post: Post, args, context: Context): Promise<User> => {
  ...
  User: {
    posts: async (user: User, args, context: Context): Promise<Post[]> => {
...
const resolvers = {
  User: {
    ...
    postCount: async (user: User, args, context: Context): Promise<number> => {
    ...
    profile: async (user: User, args, context: Context): Promise<Profile | null> => {
...
const resolvers = {
  Query: {
    user: async (parent, args: { id: string }, context: Context): Promise<User> => {
