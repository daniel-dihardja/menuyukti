...
- Cleanup plan / history: [`../menuyukti/remove-milestones.md`](../menuyukti/remove-milestones.md)

Do not implement timeline CRUD, milestone presets, or `POST .../milestones/.../run` as live features.
