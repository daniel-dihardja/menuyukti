...
Menuyukti-specific agent workflows (e.g. new GraphQL data providers) live under **`.agents/skills/menuyukti-*/`** — see [`menuyukti-data-provider`](.agents/skills/menuyukti-data-provider/SKILL.md).
