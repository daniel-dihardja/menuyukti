...
export default function ShopLayout({
  ...
  return (
    <div
      className={`${manrope.variable} ${workSans.variable} min-h-screen bg-[#faf9f6] font-[family-name:var(--font-shop-body),sans-serif] text-[#2f3430] selection:bg-[#d9eaa3] selection:text-[#37440e]`}
    >
      {children}
    </div>
  );
