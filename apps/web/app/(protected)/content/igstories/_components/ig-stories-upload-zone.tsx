...
import { CircleFadingPlus, Loader2, Upload } from 'lucide-react'
...
export type IgStoriesUploadZoneProps = {
...
export function IgStoriesUploadZone({
  inputRef,
  uploading,
  dragActive,
  onSetDragActive,
