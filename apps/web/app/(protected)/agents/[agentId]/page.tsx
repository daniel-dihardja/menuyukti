...
const AUDIENCE_OUTPUT_COVERAGE: Record<string, "covered" | "missing"> = {
  ...
  total_orders: "covered",
  total_items_sold: "covered",
  total_revenue: "covered",
  avg_order_revenue: "covered",
  max_order_revenue: "covered",
  min_order_revenue: "covered",
  avg_order_items: "covered",
  max_order_items: "covered",
  min_order_items: "covered",
  avg_popularity_threshold: "covered",
