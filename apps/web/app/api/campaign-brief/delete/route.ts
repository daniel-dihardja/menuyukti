...
import { DELETE_CAMPAIGN_BRIEF_MUTATION, type DeleteCampaignBriefData } from '@/lib/graphql/queries'
...
export async function DELETE(req: Request) {
  try {
    ...
    const message = err instanceof Error ? err.message : 'Failed to delete campaign brief'
