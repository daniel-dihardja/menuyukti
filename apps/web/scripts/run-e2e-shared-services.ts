...
const SERVICES_BY_SUITE: Record<string, ServiceName[]> = {
  ...
  "test:e2e:agents:llm-runtime": ["web", "agents"],
  "test:e2e:agents:llm-disabled-mode": ["web", "agents"],
  "test:e2e:agents:llm-evaluation-harness": ["web", "agents"],
  "test:e2e:agents:prompt-tuning-loop": ["web", "agents"],
  "test:e2e:agents:prompt-model-visibility": ["web", "agents"],
  ...
  "test:e2e:agents:llm-guardrails-fallback": ["web"],
  "test:e2e:agents:mocked-baseline-states": ["web"],
  "test:e2e:agents:phase2-handoff-readiness": ["web"],
