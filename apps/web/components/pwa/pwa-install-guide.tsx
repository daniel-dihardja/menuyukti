...
/** Shared “Add to home screen” steps for guest home and operator dashboard. */
export function PwaInstallGuide({ headingId = 'pwa-install-heading' }: PwaInstallGuideProps) {
    ...
    <section aria-labelledby={headingId} className="flex flex-col gap-4">
      <div className="flex flex-col gap-1 px-0.5">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-semibold text-base tracking-tight" id={headingId}>
            {t('sectionTitle')}
          </h2>
        </div>
