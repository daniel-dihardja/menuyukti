...
Rules:
- Always copy `startDate` and `endDate` exactly from provided context.
- Always copy `publicHolidays` exactly from provided context (do not invent, remove, or alter entries).
