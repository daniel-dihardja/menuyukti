...
func InvokeHandler(runner *gensrv.Runner) http.HandlerFunc {
...
func StreamHandler(runner *gensrv.Runner) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		if r.Body != nil {
			defer r.Body.Close()
		}
...
func writeError(w http.ResponseWriter, status int, message string) {
	writeJSON(w, status, gensrv.InvokeResponse{
		OK:    false,
		Error: message,
	})
}

func writeJSON(w http.ResponseWriter, status int, v gensrv.InvokeResponse) {
